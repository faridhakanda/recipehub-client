        ...
        <div className="min-h-screen bg-gray-50 dark:bg-zinc-950 py-4 sm:py-6 md:py-8 px-3 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white dark:bg-zinc-900 rounded-xl sm:rounded-2xl shadow-lg dark:shadow-xl dark:shadow-zinc-900/50 overflow-hidden border border-gray-200 dark:border-zinc-800">
                    {/* Header Section */}
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-700 dark:from-blue-700 dark:to-indigo-800 px-4 sm:px-6 py-5 sm:py-7">
                    ...
                    {recipeDetails.recipeImage ? (
                        ...
                        <div className="w-full h-48 sm:h-64 md:h-80 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-zinc-800 dark:to-zinc-700 flex items-center justify-center">
                    ...
                    <div className="px-3 sm:px-5 py-3 sm:py-4 border-b border-gray-200 dark:border-zinc-800">
                        <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
                            ...
                            <button className="flex items-center gap-1 px-2.5 sm:px-3 py-1 sm:py-1.5 bg-yellow-50 dark:bg-yellow-900/20 text-yellow-600 dark:text-yellow-400 hover:bg-yellow-100 dark:hover:bg-yellow-900/40 rounded-lg transition-colors border border-yellow-200 dark:border-yellow-800/50 text-xs sm:text-sm font-medium">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 sm:h-4 sm:w-4" viewBox="0 0 20 20" fill="currentColor">
