...
const RecipeDetailsPage = async ({ params }) => {
    try {
        ...
        return (
            <>
                <div className="min-h-screen bg-gray-50 dark:bg-gray-700 dark:text-gray-200 py-8 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto ">
                    ...
                    {/* Main Card */}
                    <div className="bg-white dark:bg-gray-800 dark:text-gray-200 rounded-2xl shadow-xl overflow-hidden">
                        {/* Header Section */}
