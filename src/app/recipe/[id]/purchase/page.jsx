...
import RecipePurchasePayment from './RecipePurchase';
...
const RecipePurchase = async ({ params }) => {
    ...
    console.log('recipe detail is id page: ', recipeDetail);
    const user = await getUserSession();
    console.log('user detail is id page: ', user.id);
...
// import { getRecipeById } from '@/lib/actions/allGet';
// import RecipePurchase from './RecipePurchase';
...
//     const recipe = await getRecipeById(id);
//     if(!user) {
//         redirect(`/signin?redirect=recipe/${recipe?._id}`)
//     }
//     return (
//         <div>
//         <div>
